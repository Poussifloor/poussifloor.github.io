---
layout: null
title: /travel_with_bros/Okinawa Trip
---

<style>
  body {
    font-family: "IBM Plex Sans", -apple-system, sans-serif;
    font-size: 16px; line-height: 1.6; color: #232323;
    max-width: 900px; margin: 0 auto; padding: 48px 24px 100px;
  }
  h1, h2, h3 { font-family: "IBM Plex Serif", Georgia, serif; color: #2f6690; }
  h1 { border-bottom: 3px solid #2f6690; padding-bottom: .4em; }
  h2 { color: #2f6690; margin-top: 2.2em; }
  h3 { color: #379683; }
  ...
  th { background: #2f6690; color: #fff; }
